  ...
  return (
    <div class="mt-12 border-t border-gray-200 pt-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <a
          href="details.html"
          class="border border-gray-200 rounded p-3 hover:shadow-md transition"
        >
          <div class="bg-gray-50 h-32 flex items-center justify-center mb-2">
            <img
              src="https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=200"
              class="h-full object-cover"
            />
          </div>
          <p class="text-sm text-amazon-blue hover:text-amazon-orange line-clamp-2 mb-1">
            Apple MacBook Air M2
          </p>
          <p class="text-sm font-bold">৳1,35,000</p>
        </a>
        ...
        >
          ...
          <p class="text-sm font-bold">৳1,85,000</p>
        </a>
        ...
        >
          ...
          <p class="text-sm font-bold">৳12,500</p>
        </a>
        ...
        >
          ...
          <p class="text-sm font-bold">৳8,500</p>
        </a>
        ...
        >
          ...
          <p class="text-sm font-bold">৳28,500</p>
        </a>
